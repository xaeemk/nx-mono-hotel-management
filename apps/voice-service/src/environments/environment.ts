export const environment = {
  ...
  twilio: {
    ...
    webhookUrl:
      ...
      'http://localhost:3006/api/v1/twilio/voice',
  ...
  database: {
    url:
      ...
      'postgresql://user:pass@localhost:5432/hotel_db',
  },

  // MCP Hub Configuration
  mcpHub: {
    url: process.env.MCP_HUB_URL || 'http://localhost:8080',
  },

  // File Storage
  storage: {
    audioPath: process.env.AUDIO_STORAGE_PATH || '/tmp/voice-audio',
